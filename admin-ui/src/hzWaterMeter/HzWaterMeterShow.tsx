...
export const HzWaterMeterShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
        ...
        <TextField label="lastUpdateTime" source="lastUpdateTime" />
        ...
        <TextField label="pressure" source="pressure" />
